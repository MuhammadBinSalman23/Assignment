...
public static void convertDecToHexa() {
...
String remainder="";
  ...
  Scanner sc = new Scanner(System.in);
   ...
   originalDec = dec;
   while (dec !=0 ) {
    remainder = String.valueOf( (dec % 16 ));
    ...
    System.out.println(" Decimal number "+originalDec+" its Hexadecimal is " +hexaDecimal);
} // convertDecToHexa method ends 
